...
const DEFAULT_REPO = '2406369852/cockpit-tools-codex-patch';
...
function printHelp() {
  ...
  console.log('  --repo <owner/repo>     GitHub repo for release (default: 2406369852/cockpit-tools-codex-patch)');
