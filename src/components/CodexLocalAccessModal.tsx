                            ...
                            <div className="codex-local-access-account-stat-top">
                              ...
                              <div className="codex-local-access-account-stat-block codex-local-access-account-stat-block-metrics">
                                <div className="codex-local-access-account-stat-metrics">
                                  ...
                                  <span className="codex-local-access-account-stat-pill">
                                    {t("codex.accountCost.usedUsd", "已用美元")} {formatCodexEstimatedCostUsd(
                                      accountStats?.estimatedCostUsd,
                                    )}
                                  </span>
                                  <span className="codex-local-access-account-stat-pill">
                                    {t("codex.accountCost.actualPrice", "实际价格")} {formatCodexActualSpendCny(
                                      account.actual_spend_cny,
                                    )}
                                  </span>
                                  <span className="codex-local-access-account-stat-pill">
                                    {t("codex.accountCost.multiplier", "倍率")} {formatCodexAccountCostMultiplier(
                                      calculateCodexAccountCostMultiplier(
                                        account.actual_spend_cny,
                                        accountStats?.estimatedCostUsd,
                                      ),
